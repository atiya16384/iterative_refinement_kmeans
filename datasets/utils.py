...
synth_specs = [
    ...
    ("SYNTH_C_5_F_5_n100k", 100_000, 5,  5, 0),
    ("SYNTH_C_80_F_5_n100k", 1000_00, 5, 80, 1),
    ("SYNTH_C_30_F_5_n100k", 1000_00, 5, 30, 1)
]
...
columns_D = [
    "DatasetName", "DatasetSize", "NumClusters", "Mode", "tolerance_single", "Cap", "iter_single", "iter_double",
