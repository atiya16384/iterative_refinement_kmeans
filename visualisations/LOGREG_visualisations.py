...
class LogisticVisualizer:
    ...
    def plot_cap_vs_time(self, df_A):
        """Cap vs Time for Experiment A"""
        plt.figure(figsize=(8, 6))
        sns.lineplot(
            data=df_A, x="Cap", y="Time",
            hue="Mode", marker="o", ci=None
        )
    ...
    def plot_cap_vs_accuracy(self, df_A):
        """Cap vs Accuracy for Experiment A"""
        plt.figure(figsize=(8, 6))
        sns.lineplot(
            data=df_A, x="Cap", y="Accuracy",
            hue="Mode", marker="o", ci=None
        )
    ...
    def plot_tolerance_vs_time(self, df_B):
        """Tolerance vs Time for Experiment B"""
        plt.figure(figsize=(8, 6))
        sns.lineplot(
            data=df_B, x="tolerance_single", y="Time",
            hue="Mode", marker="o", ci=None
        )
    ...
    def plot_tolerance_vs_accuracy(self, df_B):
        """Tolerance vs Accuracy for Experiment B"""
        plt.figure(figsize=(8, 6))
        sns.lineplot(
            data=df_B, x="tolerance_single", y="Accuracy",
            hue="Mode", marker="o", ci=None
        )
