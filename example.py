    ...
    for n_clusters in n_clusters_list:
        for n_features in n_features_list:
            for repeat in range(n_repeats):
                ...
                # Full double precision run
                centers_double, labels_double, inertia, elapsed, mem_MB, ari, silhouette, dbi = run_full_double(
                    X, initial_centers, n_clusters, max_iter, repeat, y_true
                )

                results.append([n_samples, n_clusters, n_features, "Double", 0, elapsed, mem_MB,
