...
from experiments.kmeans_precision import run_full_double, run_hybrid,  run_expD_adaptive_sklearn, run_expE_minibatch_then_full,run_expF_percluster_mixed, run_hybrid_optimized  
import numpy as np
import time
import numpy as np
